...
##load train data
file = h5py.File('data/train_blind123.h5', 'r')
in_train = file['data'][:]
...
file = h5py.File('data/val_blind123.h5', 'r')
in_test = file['data'][:]
out_test = file['label'][:]
file.close()
...
model.save_weights('srcnn_model_weights_blur1234.h5')
model.save_weights('srcnn_model_blur1234.h5')
